...
# Enhanced AWS Cybersecurity Lab Bootstrap Script
...
declare -A FILE_MAPPING=(
    ...
    ["updated-main.tf"]="main.tf"
    ["updated-variables.tf"]="variables.tf"
...
generate_password() {
    if [ -z "$DOMAIN_ADMIN_PASSWORD" ]; then
        ...
        DOMAIN_ADMIN_PASSWORD="CyberSec$(openssl rand -base64 12 | tr -d "=+/" | cut -c1-8)!"
